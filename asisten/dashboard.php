...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
    ...
    <a href="kelola_user.php" class="bg-white p-6 rounded-lg shadow-md flex items-center space-x-4 hover:bg-blue-50 transition">
        ...
        <div>
            ...
            <p class="text-2xl font-bold text-gray-800">Pengguna</p>
        </div>
    </a>
...
<div class="bg-white p-6 rounded-lg shadow-md mt-8">
    ...
    <div class="space-y-4">
        ...
        <div class="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center mr-4">
            ...
            <div>
                <p class="text-gray-800"><strong>Naufal Khalifanny</strong> mengumpulkan laporan untuk <strong>Modul 1</strong></p>
